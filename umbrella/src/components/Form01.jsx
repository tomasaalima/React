    ...
    <div className="border-2 bg-white border-gray-300 rounded-lg h-full w-full sm:h-auto sm:w-80 md:w-96  p-8">
      ...
      <form className="mt-8 space-y-6" onSubmit={onSubmit}>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="group relative flex w-24 justify-center rounded-md bg-blue-900 py-2 px-3 text-sm font-semibold text-white hover:bg-azul/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-azul cursor-pointer"
          >
            Próximo
          </button>
        </div>
